...
<title>Expediente Digital | Documento técnico</title>
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .fase { display: flex; gap: 1.1rem; align-items: flex-start; margin-bottom: 1.2rem; }
  .fase .num { flex: 0 0 auto; width: 2.4rem; height: 2.4rem; border-radius: 50%; background: var(--azul); color: #fff; font-family: "Raleway", sans-serif; font-weight: 800; font-size: 1.05rem; display: flex; align-items: center; justify-content: center; }
  .fase h4 { font-family: "Raleway", sans-serif; font-weight: 700; font-size: 1.05rem; margin: .3rem 0 .35rem; color: var(--texto); }
  .fase p:last-child { margin-bottom: 0; }
...
<header class="portada">
  ...
  <p class="eyebrow">Documento técnico · Dirección de Tecnología</p>
  <h1>Expediente <span class="amarillo">Digital</span> — documento técnico</h1>
  <p class="bajada">Documentación del sistema tal como está hoy: alcance funcional, modelo de datos tabla por tabla, diagrama de clases del dominio, la infraestructura sobre la que corre, el catálogo completo de casos de uso con sus flujos, y los términos de la donación a la Fundación.</p>
  <div class="chips">
...
<article>
  ...
  <p><strong>Qué es.</strong> Un monolito web que digitaliza el ciclo operativo de una Casa Ronald McDonald: el expediente del menor albergado y de sus acompañantes —incluido el estudio socioeconómico que trabajo social ya levanta—, una credencial imprimible con código QR de seis caracteres, el registro por escaneo de cada servicio (comedor, lavandería, escuelita, transporte, entradas y salidas) y los concentrados y reportes que salen de esos registros.</p>
  <p><strong>Cómo está construido.</strong> Laravel renderizado en servidor, con Blade y jQuery en el navegador y MariaDB detrás. Sin colas, sin caché distribuida, sin microservicios y sin dependencias de infraestructura exóticas: la decisión de fondo es que el sistema pueda ser operado y mantenido por cualquier proveedor o voluntario técnico, no solo por quien lo escribió.</p>
  <p><strong>Qué se ofrece.</strong> Donación del sistema completo bajo licencia MIT a nombre de la Fundación, con puesta en marcha, capacitación y acompañamiento. Sin costo y sin dependencia del donante: el repositorio, la documentación y los datos quedan en manos de la organización.</p>
  <p><strong>Qué se pide de Tecnología.</strong> Revisión de este documento, los requisitos corporativos que el despliegue deba cumplir (hosting, seguridad, cumplimiento) y un criterio sobre el entorno del piloto.</p>
...
<article>
  ...
  <p>La cobertura funcional se definió desde la operación observada como voluntario, y sigue el proceso público de admisión de la Fundación: la familia llega canalizada por trabajo social del hospital con solicitud, valoración médica y estudio socioeconómico. Cada paso de ese proceso tiene su contraparte en el sistema.</p>
  <div class="tabla-scroll"><table>
    <tr><th>Proceso real de la Casa</th><th>Módulo del sistema</th><th>Datos que captura</th></tr>
    <tr><td>Solicitud de hospedaje vía trabajo social</td><td>Expediente del menor<br><code>/expedientes</code></td><td>Identidad, fecha de nacimiento, sexo, hospital, diagnóstico, médico tratante, alergias, dieta, estatus de estancia (primera vez, prórroga, subsecuente) y fechas de solicitud, ingreso y salida</td></tr>
    <tr><td>Estudio socioeconómico</td><td>Mismo expediente + acompañantes</td><td>Escolaridad, ocupación, ingreso mensual, dependientes económicos, vivienda propia, seguro médico, apoyo financiero, zona (rural, suburbana, urbana), clasificación social, salario mínimo y dialecto o lengua</td></tr>
    <tr><td>Familias de todo el país</td><td>Catálogos de geografía</td><td><code>pais → estado → municipio</code>: 3 países, 32 estados y 97 municipios precargados</td></tr>
    <tr><td>Red de hospitales de Puebla</td><td>Catálogo <code>hospital</code></td><td>17 hospitales de la operación real: Hospital para el Niño Poblano, CRIT, IMSS Margarita, Cruz Roja Puebla, entre otros</td></tr>
    <tr><td>Credencial de la familia</td><td>Generador de carnet<br><code>/fichas/{nino}</code></td><td>Carnet tamaño carta (1275×1650 px) con identidad de la Fundación, datos del menor, procedencia, hospital, acompañantes con línea de firma y el QR</td></tr>
    <tr><td>Comedor (tres comidas, dietas)</td><td rowspan="2">Registro de servicios por escaneo</td><td rowspan="2">Bitácora <code>registros_servicios</code>: un renglón por evento con servicio y marca de tiempo. La confirmación del escaneo devuelve la dieta y las alergias del menor</td></tr>
    <tr><td>Lavandería · Escuelita · Transporte</td></tr>
    <tr><td>Control de acceso al albergue</td><td>Entradas y salidas por escaneo</td><td>Bitácora <code>entradas_salidas</code>: la entrada abre el renglón y la salida lo cierra; una salida sin entrada abierta se rechaza</td></tr>
    <tr><td>Reportes a patronato y donantes</td><td>Concentrados y reportes</td><td>Tablas por servicio, gráfico de uso por periodo y descarga de la bitácora en Excel</td></tr>
    <tr><td>Resguardo del expediente</td><td>Reporte PDF y auditoría</td><td>Expediente completo en PDF con foto y QR incrustados; bitácora de qué cuenta hizo qué y cuándo</td></tr>
  </table></div>
  <p><strong>Fuera de alcance por ahora</strong>, previsto como evolución: el módulo de habitaciones y ocupación (la tabla <code>registro_operativo</code> ya está modelada, pero sin pantallas), la administración del catálogo de trabajadoras sociales desde la interfaz, y la extensión a varias Casas y Salas Familiares con datos segregados por sede.</p>
</article>

<article>
  <h2>3 · Modelo de datos</h2>
...
<article>
  ...
  <h3>Marco legal</h3>
  <p>El sistema maneja datos personales de menores y datos sensibles —salud y situación socioeconómica— bajo la <strong>Ley Federal de Protección de Datos Personales en Posesión de los Particulares</strong>. Eso implica aviso de privacidad y consentimiento en el momento del registro, atención a los derechos ARCO y minimización de datos: el sistema captura únicamente lo que el expediente en papel ya recaba, ni un campo más.</p>
  ...
  <h3>Lo que depende de la Fundación</h3>
  <div class="honesto">
    <p>Estas piezas son decisiones de la organización, no deuda del código: <strong>certificado TLS válido</strong> sobre un dominio propio; <strong>respaldos fuera de la instancia</strong>, que hoy conviven con la aplicación en el mismo disco; el <strong>aviso de privacidad y el consentimiento</strong> en el registro, con el procedimiento de derechos ARCO; y la <strong>política de retención y borrado</strong> al egreso de cada familia.</p>
  </div>

  <h3>Revisión corporativa</h3>
  <p>El código es abierto y auditable. Estamos en plena disposición de someterlo al proceso de revisión de seguridad del corporativo —análisis estático, pruebas de penetración, cuestionarios de proveedor— antes del piloto, y de ajustar lo que resulte.</p>
</article>

<article>
  <h2>9 · Calidad, licencia y siguientes pasos</h2>
  ...
  <p>Las pruebas corren sobre sqlite en memoria y cubren los flujos que importan: autenticación y autorización por rol, alta y edición de expedientes, las reglas de entrada y salida, la unicidad del QR, la generación del carnet y del PDF, los feeds de las tablas, los reportes y la administración de cuentas. El estilo se verifica con <code>pint</code>.</p>

  <h3>Licencia y entrega</h3>
  <ul>
    <li><strong>Licencia MIT</strong>, con el repositorio transferido a la Fundación. Sin costo presente ni futuro y sin dependencia del donante.</li>
    <li><strong>Entregables</strong>: código, este documento técnico, la guía de uso para el personal de la Casa y los scripts de aprovisionamiento y despliegue.</li>
    <li><strong>Los datos son de la Fundación</strong> y exportables en cualquier momento: MySQL/MariaDB estándar, sin formatos propietarios.</li>
    <li><strong>Sostenibilidad</strong>: el stack (PHP, Laravel, MySQL) tiene oferta amplia de talento en México, así que cualquier proveedor o voluntario técnico puede mantenerlo.</li>
  </ul>

  <h3>Siguientes pasos que proponemos</h3>
  <div class="fase">
    <div class="num">1</div>
    <div>
      <h4>Piloto acotado, cuatro semanas</h4>
      <p>Un solo servicio —sugerimos el comedor— en la Casa Puebla, con credenciales reales y medición: minutos ahorrados por comida servida, exactitud del concentrado mensual contra el conteo manual y retroalimentación de las trabajadoras sociales y del personal operativo.</p>
    </div>
  </div>
  <div class="fase">
    <div class="num">2</div>
    <div>
      <h4>Consolidación</h4>
      <p>El resto de los servicios, el módulo de estancia y habitaciones completo y —si la Fundación lo decide— la extensión a varias Casas y Salas Familiares con datos segregados por sede.</p>
    </div>
  </div>

  <h3>Requisitos de operación</h3>
  <ul>
    <li><strong>Servidor</strong>: una instancia modesta (2 vCPU, 1–4 GB) o el estándar corporativo que Tecnología defina. Es un monolito PHP + MySQL convencional, empaquetable en contenedores si la política lo requiere.</li>
    <li><strong>En sitio</strong>: una computadora con internet y una impresora para las credenciales; en cada punto de servicio, un teléfono o un lector QR por USB.</li>
    <li><strong>Cuentas</strong>: una por persona del equipo, creadas y administradas por la dirección de la Casa desde el propio sistema.</li>
  </ul>

  <h3>Cómo verlo funcionando</h3>
  <p>La instancia de demostración está en línea con datos ficticios — la familia de prueba es, cómo no, la de <em>Ronaldo Macías Zepeda</em>, con el código <span class="qr">R2M4Z6</span>. Ningún dato de familias reales ha pasado nunca por el sistema. Con gusto damos acceso, hacemos un recorrido en vivo o abrimos el repositorio cuando lo indiquen.</p>
</article>
