...
@section('content')
    ...
    <script>
        $(function () {
            $('#data-table-lavanderia').DataTable({
                processing: true,
                serverSide: true,
                order: [[4, 'desc']],
                ajax: "{{ route('registros.datatable', 'lavanderia') }}",
                columns: [
                    {data: 'id', name: 'id'},
                    ...
                    {data: 'servicio_nombre', orderable: false, searchable: false, render: function (data) {
                        return '<i class="fa fa-tint"></i> ' + data;
                    }},
